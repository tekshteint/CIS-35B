...
public abstract class proxyAutomobile {
	...
	public static String PrintAllAutos() {
		String response = "";
		for (int i=1; i<=AutomobileLinkedHashMap.getgarageObjects().size() ;i++)
			response+=AutomobileLinkedHashMap.getObject(i).getArrayListTable();
		return response;
	}
